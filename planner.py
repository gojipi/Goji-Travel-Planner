...
st.markdown("""
    ...
    h1 { font-family: 'Montserrat', sans-serif !important; color: #f1c40f !important; font-size: 48px !important; text-align: center; text-shadow: 2px 2px #000000; }
    div[data-testid="stMetricContainer"] { background-color: #1a1f29; border: 1px solid #3498db; border-radius: 12px; padding: 20px; }
    [data-testid="stSidebar"] { background-color: #161b22 !important; border-right: 1px solid #3498db; }
    button, [data-testid="stHeader"], [data-testid="stIcon"], svg, [data-testid="collapsedControl"] { font-family: inherit !important; }
    </style>
...
with st.sidebar:
    ...
    db = {
        "Bangkok": {"rate": 7.50, "curr": "THB", "weather": "32°C Hot", "cloth": "Cotton", "sos": "1155", "tiket": 450, "food": ["Volcanic Ribs", "Mango Sticky Rice", "Yaowarat Bread"]},
        "Phuket": {"rate": 7.50, "curr": "THB", "weather": "30°C Tropical", "cloth": "Beachwear", "sos": "1155", "tiket": 380, "food": ["Grilled Lobster", "Pad Thai", "Cashew Nuts"]},
        "Danang": {"rate": 5200.0, "curr": "VND", "weather": "28°C Windy", "cloth": "Casual", "sos": "113", "tiket": 650, "food": ["Banh Mi Phuong", "Seafood BBQ", "Vietnamese Coffee"]},
        "Sabah": {"rate": 1.0, "curr": "MYR", "weather": "27°C Fresh", "cloth": "Outdoor", "sos": "999", "tiket": 250, "food": ["Sinalau Bakas", "Tuaran Mee", "Desa Milk"]},
        "Sarawak": {"rate": 1.0, "curr": "MYR", "weather": "29°C Humid", "cloth": "Casual", "sos": "999", "tiket": 150, "food": ["Laksa Sarawak", "Kolo Mee", "Gula Apong Ice Cream"]},
        "China (Beijing)": {"rate": 1.55, "curr": "CNY", "weather": "15°C Cold", "cloth": "Jacket", "sos": "110", "tiket": 1200, "food": ["Peking Duck", "Hutong Snacks", "Dumplings"]},
        "South Korea": {"rate": 285.0, "curr": "KRW", "weather": "12°C Chilly", "cloth": "Coat", "sos": "1330", "tiket": 1500, "food": ["Tteokbokki", "Korean Fried Chicken", "K-BBQ"]},
        "Japan (Tokyo)": {"rate": 32.0, "curr": "JPY", "weather": "14°C Refresh", "cloth": "Sneakers", "sos": "110", "tiket": 1800, "food": ["Tsukiji Sushi", "Ichiran Ramen", "Wagyu Beef"]}
    }
    
    info = db[destinasi]
    
    # --- BUDGET CALCULATOR (MASUK BALIK) ---
    ...
    total_budget = (hari * hotel) + (hari * makan) + info['tiket']
...
c1.metric("TOTAL BUDGET", f"RM{total_budget}")
c2.metric("FLIGHT (EST)", f"RM{info['tiket']}")
c3.metric("WEATHER", info['weather'])
c4.metric("DRESS CODE", info['cloth'])

st.divider()

# 5. ITINERARY DATABASE (FULL - NO TRIMMING)
itineraries = {
    "Bangkok": """
    ...
    * **Day 2: Kundasang Trip** - Drive to Kundasang. Visit Desa Dairy Farm & Alpaca Farm.
    ...
    * **Day 6: Lotte World or Gangnam** - Theme park fun atau Gangnam district.
    ...
    * **Day 5: Disney Day** - Full day at Tokyo DisneySea atau Tokyo Disneyland.
...
with tab2:
    ...
    with col_b:
        ...
        st.warning("Emergency Embassy contact: Reach out to Malaysian Mission.")

with tab3:
    st.header("🖼️ Memory Bank")
    g1, g2 = st.columns(2)
    with g1:
        st.image("https://images.unsplash.com/photo-1552465011-b4e21bf6e79a?q=80&w=1000", caption="Phuket")
    with g2:
        st.image("https://images.unsplash.com/photo-1512100356956-c1227c331f01?q=80&w=1000", caption="Travel")

with tab4:
    st.subheader("📝 Travel Log")
    st.text_area("Record your spending or daily notes here...", height=300)
