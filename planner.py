...
# 2. CSS ANTI-GLITCH & NEON UI (VERSI TERPALING FIX)
st.markdown("""
    <style>
...
# 5. ITINERARY DATABASE (THE KNOWLEDGE - NO TRIMMING)
itineraries = {
    "Bangkok": """
    ...
    * **Day 7: Last Massage & Fly** - Foot massage at Let's Relax, grab snacks at Big C Supercenter, and head to BKK/DMK.
    """,
    "Phuket": """
    ...
    * **Day 2: Kundasang Trip** - Drive to Kundasang. Visit Desa Dairy Farm (New Zealand vibes) & Rabbit Farm.
    * **Day 3: Nature & Springs** - Poring Hot Spring, Canopy Walk, and find the Rafflesia flower if in season.
    * **Day 4: Kinabalu Park** - Botanical Garden tour at the base of Mt. Kinabalu. Fresh air and cool breeze.
    ...
    * **Day 2: Bako National Park** - Boat ride to see Proboscis Monkeys, wild boars, and iconic sea stacks.
    ...
    * **Day 7: Hutong Tour** - Rickshaw ride through old alleys. Tea ceremony experience before heading to PEK/PKX.
    """,
    "South Korea": """
...
with tab2:
    ...
    with col_b if 'col_b' in locals() else c_b:
...
with tab3:
    ...
    st.write("Future spot for your sunset photography!")
